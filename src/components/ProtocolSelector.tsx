...
const protocols = [
  { id: 'echo' as const, name: 'ECHO', description: 'ECHO Protocol (RFC 862) - The simplest TCP test protocol', port: 7, icon: '🔊', features: ['Network testing', 'Latency measurement', 'Connectivity verification'], status: 'deprecated' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'specialty' as ProtocolCategory , year: 2023 },
  { id: 'whois' as const, name: 'WHOIS', description: 'WHOIS Protocol (RFC 3912) - Domain registration information lookup', port: 43, icon: '🔍', features: ['Domain registration info', 'Auto-detect WHOIS server', 'IP/ASN lookup'], status: 'deprecated' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'network' as ProtocolCategory , year: 2023 },
  ...
  { id: 'socks4' as const, name: 'SOCKS4', description: 'SOCKS4 Protocol - TCP connection proxying through firewalls', port: 1080, icon: '🔀', features: ['Proxy testing', 'SOCKS4a hostname support', 'SSH tunneling'], status: 'deprecated' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'network' as ProtocolCategory , year: 2023 },
  { id: 'daytime' as const, name: 'Daytime', description: 'Daytime Protocol (RFC 867) - Human-readable time from remote servers', port: 13, icon: '🕐', features: ['Simplest time protocol', 'Educational', 'Clock synchronization check'], status: 'deprecated' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'specialty' as ProtocolCategory , year: 2023 },
  { id: 'finger' as const, name: 'Finger', description: 'Finger Protocol (RFC 1288) - Legacy user information lookup', port: 79, icon: '👤', features: ['User information', 'Educational', 'Internet archaeology'], status: 'deprecated' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'specialty' as ProtocolCategory , year: 2023 },
  ...
  { id: 'discard' as const, name: 'Discard', description: 'Discard Protocol (RFC 863) - Silently discards all data sent to it', port: 9, icon: '🗑️', features: ['Fire-and-forget testing', 'Throughput measurement', 'Data sink for debugging'], status: 'deprecated' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'specialty' as ProtocolCategory , year: 2026 },
  { id: 'gemini' as const, name: 'Gemini', description: 'Gemini Protocol - Modern privacy-focused alternative to HTTP/HTML', port: 1965, icon: '💎', features: ['TLS mandatory', 'Simple Gemtext markup', 'No tracking/cookies'], status: 'niche' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'specialty' as ProtocolCategory , year: 2025 },
  { id: 'ftp' as const, name: 'FTP (Passive Mode)', description: 'File Transfer Protocol - Transfer files to/from FTP servers', port: 21, icon: '📁', features: ['Directory listing', 'File upload/download', 'Passive mode support'], status: 'active' as ProtocolStatus, popularity: 'moderate' as PopularityTier, category: 'files' as ProtocolCategory , year: 2025 },
  { id: 'ssh' as const, name: 'SSH', description: 'Secure Shell - Execute commands on remote servers', port: 22, icon: '🔐', features: ['Private key authentication', 'Password authentication', 'Encrypted connection'], status: 'active' as ProtocolStatus, popularity: 'ubiquitous' as PopularityTier, category: 'remote' as ProtocolCategory , year: 2025 },
  { id: 'telnet' as const, name: 'Telnet', description: 'Telnet Protocol - Unencrypted text-based terminal protocol', port: 23, icon: '📟', features: ['Interactive terminal', 'Command execution', 'WebSocket tunnel'], status: 'active' as ProtocolStatus, popularity: 'moderate' as PopularityTier, category: 'remote' as ProtocolCategory , year: 2025 },
  { id: 'smtp' as const, name: 'SMTP', description: 'Simple Mail Transfer Protocol - Send emails via SMTP servers', port: 587, icon: '📧', features: ['Email sending', 'AUTH LOGIN support', 'Multiple ports (25/587/465)'], status: 'active' as ProtocolStatus, popularity: 'ubiquitous' as PopularityTier, category: 'email' as ProtocolCategory , year: 2025 },
  { id: 'submission' as const, name: 'Submission', description: 'Message Submission Protocol (RFC 6409) - Authenticated mail submission on port 587 with STARTTLS', port: 587, icon: '📮', features: ['STARTTLS support', 'Authenticated submission', 'AUTH before MAIL FROM', 'RFC 6409 compliance'], status: 'active' as ProtocolStatus, popularity: 'common' as PopularityTier, category: 'email' as ProtocolCategory , year: 2025 },
  { id: 'pop3' as const, name: 'POP3', description: 'Post Office Protocol v3 - Retrieve emails from mail servers', port: 110, icon: '📬', features: ['Email retrieval', 'Message listing', 'Mailbox management'], status: 'active' as ProtocolStatus, popularity: 'moderate' as PopularityTier, category: 'email' as ProtocolCategory , year: 2025 },
  { id: 'imap' as const, name: 'IMAP', description: 'Internet Message Access Protocol - Advanced email management', port: 143, icon: '📮', features: ['Multiple folders', 'Server-side organization', 'Message flags'], status: 'active' as ProtocolStatus, popularity: 'ubiquitous' as PopularityTier, category: 'email' as ProtocolCategory , year: 2025 },
  { id: 'mysql' as const, name: 'MySQL', description: 'MySQL Database - Connectivity testing for MySQL servers', port: 3306, icon: '🗄️', features: ['Server handshake', 'Version detection', 'Connection testing'], status: 'active' as ProtocolStatus, popularity: 'common' as PopularityTier, category: 'databases' as ProtocolCategory , year: 2025 },
  { id: 'postgres' as const, name: 'PostgreSQL', description: 'PostgreSQL Database - Connectivity testing for PostgreSQL servers', port: 5432, icon: '🐘', features: ['Startup message', 'Authentication check', 'Connection testing'], status: 'active' as ProtocolStatus, popularity: 'common' as PopularityTier, category: 'databases' as ProtocolCategory , year: 2025 },
  { id: 'redis' as const, name: 'Redis', description: 'Redis In-Memory Store - Key-value store and cache server', port: 6379, icon: '⚡', features: ['RESP protocol', 'Command execution', 'AUTH & database selection'], status: 'active' as ProtocolStatus, popularity: 'common' as PopularityTier, category: 'databases' as ProtocolCategory , year: 2025 },
  { id: 'mqtt' as const, name: 'MQTT', description: 'MQTT Protocol - Lightweight IoT messaging protocol', port: 1883, icon: '📡', features: ['Publish/subscribe', 'MQTT 3.1.1', 'Username/password auth'], status: 'active' as ProtocolStatus, popularity: 'common' as PopularityTier, category: 'messaging' as ProtocolCategory , year: 2025 },
  { id: 'ldap' as const, name: 'LDAP', description: 'LDAP Protocol - Directory services and authentication', port: 389, icon: '📂', features: ['BIND operation', 'Anonymous/authenticated bind', 'ASN.1/BER encoding'], status: 'active' as ProtocolStatus, popularity: 'ubiquitous' as PopularityTier, category: 'network' as ProtocolCategory , year: 2025 },
  { id: 'ldaps' as const, name: 'LDAPS', description: 'LDAP over TLS - Secure directory services with implicit TLS', port: 636, icon: '🔒', features: ['Implicit TLS encryption', 'Secure bind (anonymous/authenticated)', 'Base DN search over TLS'], status: 'active' as ProtocolStatus, popularity: 'ubiquitous' as PopularityTier, category: 'network' as ProtocolCategory , year: 2025 },
  ...
  { id: 'irc' as const, name: 'IRC', description: 'IRC Protocol (RFC 2812) - Real-time internet relay chat', port: 6667, icon: '💬', features: ['Channel chat', 'Private messaging', 'Interactive WebSocket session'], status: 'active' as ProtocolStatus, popularity: 'moderate' as PopularityTier, category: 'messaging' as ProtocolCategory , year: 2025 },
  { id: 'ircs' as const, name: 'IRCS', description: 'IRC over TLS (RFC 7194) - Encrypted real-time internet relay chat with implicit TLS on port 6697', port: 6697, icon: '🔐', features: ['Implicit TLS encryption', 'Channel chat', 'Private messaging', 'Interactive WebSocket session'], status: 'active' as ProtocolStatus, popularity: 'moderate' as PopularityTier, category: 'messaging' as ProtocolCategory , year: 2025 },
  { id: 'gopher' as const, name: 'Gopher', description: 'Gopher Protocol (RFC 1436) - Pre-Web hypertext browsing from 1991', port: 70, icon: '🐿️', features: ['Menu browsing', 'Search servers', 'Internet archaeology'], status: 'deprecated' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'files' as ProtocolCategory , year: 2023 },
  { id: 'memcached' as const, name: 'Memcached', description: 'Memcached Protocol - Distributed memory caching system', port: 11211, icon: '🧊', features: ['Cache inspection', 'Key-value operations', 'Stats monitoring'], status: 'active' as ProtocolStatus, popularity: 'common' as PopularityTier, category: 'databases' as ProtocolCategory , year: 2025 },
  ...
  { id: 'amqp' as const, name: 'AMQP', description: 'AMQP 0-9-1 Protocol - Message broker connectivity (RabbitMQ)', port: 5672, icon: '🐇', features: ['Broker detection', 'Version & platform info', 'Auth mechanism discovery'], status: 'active' as ProtocolStatus, popularity: 'common' as PopularityTier, category: 'messaging' as ProtocolCategory , year: 2025 },
  ...
  { id: 'rsync' as const, name: 'Rsync', description: 'Rsync Daemon Protocol - File synchronization and module discovery', port: 873, icon: '🔄', features: ['Version detection', 'Module listing', 'Auth requirement check'], status: 'active' as ProtocolStatus, popularity: 'moderate' as PopularityTier, category: 'files' as ProtocolCategory , year: 2025 },
  ...
  { id: '9p' as const, name: '9P', description: '9P Protocol (Plan 9) - Network filesystem where everything is a file', port: 564, icon: '📁', features: ['Version negotiation', 'Filesystem attach', 'Used by QEMU & WSL2'], status: 'niche' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'files' as ProtocolCategory , year: 2025 },
      ...
      {activeTab === 'rfcs' && (
        <div className="max-w-7xl mx-auto mt-8">
          <div className={`${isRetro ? 'retro-box' : 'bg-slate-800 border border-slate-600 rounded-xl'} p-6`}>
            <h2 className={`text-3xl font-bold mb-6 ${isRetro ? 'retro-text retro-glow' : 'text-white'}`}>
              Protocol RFCs & Implementation Status
            </h2>
            <p className={`${isRetro ? 'retro-text' : 'text-slate-300'} text-sm mb-6`}>
              Comprehensive list of all protocol RFCs, their implementation status on Cloudflare Workers, and technical details.
            </p>
              ...
              <table className={`w-full ${isRetro ? 'retro-text' : 'text-sm'}`}>
                <thead>
                  <tr className={isRetro ? 'retro-border' : 'border-b-2 border-slate-600'}>
                    ...
                    <th className={`text-left py-3 px-4 ${isRetro ? 'retro-text' : 'text-slate-300 font-semibold'}`}>RFC</th>
                ...
                <tbody>
                  {protocols.map((protocol, idx) => {
                    // Extract RFC number from description
                    const rfcMatch = protocol.description.match(/RFC\s*(\d+)/i);
                    const rfcNumber = rfcMatch ? rfcMatch[1] : null;
                    const isImplemented = protocol.status === 'active' || protocol.status === 'niche';
                    const isWorkersCompatible = true; // All protocols here are compatible since they're all implemented

                    return (
                      <tr key={protocol.id} className={`${isRetro ? 'retro-border' : 'border-b border-slate-700'} ${idx % 2 === 0 ? (isRetro ? '' : 'bg-slate-800/50') : ''}`}>
                        <td className={`py-3 px-4 ${isRetro ? 'retro-text' : 'text-white font-medium'}`}>
                          <div className="flex items-center gap-2">
                            <span className="text-xl" aria-hidden="true">{protocol.icon}</span>
                            {protocol.name}
                          </div>
                        </td>
                        <td className={`py-3 px-4 ${isRetro ? 'retro-text-amber' : 'text-blue-400'}`}>
                          {rfcNumber ? (
                            <a
                              href={`https://www.rfc-editor.org/rfc/rfc${rfcNumber}.html`}
                              target="_blank"
                              rel="noopener noreferrer"
                        ...
                        <td className={`py-3 px-4 ${isRetro ? 'retro-text' : 'text-slate-300'} text-xs`}>
                          {protocol.description.replace(/\s*\(RFC.*?\)\s*-?\s*/i, ' - ')}
                        </td>
            ...
            <div className={`mt-6 ${isRetro ? 'retro-box' : 'bg-slate-700/50 rounded-lg'} p-4`}>
              <p className={`text-xs ${isRetro ? 'retro-text' : 'text-slate-400'}`}>
                <strong className={isRetro ? 'retro-text' : 'text-slate-300'}>Note:</strong> All protocols listed are compatible with Cloudflare Workers TCP Sockets API.
                Protocols marked as "Deprecated" are historical implementations that are still functional but no longer recommended for production use.
              </p>
            </div>
          </div>
        </div>
