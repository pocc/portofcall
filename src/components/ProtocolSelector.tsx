...
export const protocols = [
  ...
  { id: 'informix' as const, name: 'IBM Informix', description: 'IBM Informix Dynamic Server — SQLI wire protocol over onsoctcp', port: 9088, icon: '🗄️', features: ['SQLI protocol probe', 'Server version detection', 'Connectivity testing'], status: 'active' as ProtocolStatus, popularity: 'rare' as PopularityTier, category: 'databases' as ProtocolCategory, year: 1985 },
