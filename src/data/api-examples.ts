...
const examples: Record<string, CurlExample[]> = {
  ...
  -H 'Content-Type: application/json' \
  -d '{"host":"test.rebex.net","port":22}'` },
    { title: 'POST /sftp/list (501)', command: `curl -X POST 'https://l4.fyi/api/sftp/list' \
  -H 'Content-Type: application/json' \
  -d '{"host":"your-server.example.com","port":22,"username":"sftpuser","password":"secret","path":"/home/sftpuser"}'` },
  ...
  -H 'Content-Type: application/json' \
  -d '{"host":"your-server.example.com","port":22,"username":"sftpuser","password":"secret","path":"/home/sftpuser/new-directory"}'` },
    { title: 'POST /sftp/rename (501)', command: `curl -X POST 'https://l4.fyi/api/sftp/rename' \
  -H 'Content-Type: application/json' \
  -d '{"host":"your-server.example.com","port":22,"username":"sftpuser","password":"secret","oldPath":"/home/sftpuser/draft.txt","newPath":"/home/sftpuser/final.txt"}'` },
