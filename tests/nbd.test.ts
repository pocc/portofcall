/**
 * NBD (Network Block Device) Protocol Integration Tests
 * Tests newstyle handshake detection and export listing
 */
...
describe('NBD Protocol Integration Tests', () => {
  describe('NBD Connect (HTTP)', () => {
    it('should handle connection to non-existent host', async () => {
      const response = await fetch(`${API_BASE}/nbd/connect`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          host: 'non-existent-nbd-12345.example.com',
          port: 10809,
          timeout: 5000,
        }),
      });
  ...
  describe('NBD Probe (HTTP)', () => {
    it('should handle probe to non-existent host', async () => {
      const response = await fetch(`${API_BASE}/nbd/probe`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          host: 'non-existent-nbd-12345.example.com',
  ...
  describe('NBD Cloudflare Detection', () => {
