/**
 * Tarantool IPROTO Protocol Integration Tests
 * Tests greeting banner detection and IPROTO_PING
 */
...
describe('Tarantool Protocol Integration Tests', () => {
  describe('Tarantool Connect (HTTP)', () => {
    it('should handle connection to non-existent host', async () => {
      const response = await fetch(`${API_BASE}/tarantool/connect`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          host: 'non-existent-tarantool-12345.example.com',
          port: 3301,
          timeout: 5000,
        }),
      });
  ...
  describe('Tarantool Probe (HTTP)', () => {
    it('should handle probe to non-existent host', async () => {
      const response = await fetch(`${API_BASE}/tarantool/probe`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          host: 'non-existent-tarantool-12345.example.com',
  ...
  describe('Tarantool Cloudflare Detection', () => {
  ...
  describe('Tarantool Response Format', () => {
